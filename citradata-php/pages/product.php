            ...
            <div class="max-w-4xl mx-auto px-4 md:px-6 space-y-12">
                ...
                <article class="bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
                    <div class="flex items-center gap-5 mb-8 pb-8 border-b border-slate-100">
                        ...
                        <div>
                            <h2 class="text-3xl font-extrabold tracking-tight text-slate-900">Construction Data</h2>
                            <p class="text-sm text-slate-500 font-medium mt-1">Digital & Printed Project Information</p>
                        </div>
                    </div>
                ...
                <article class="bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
                    <div class="flex items-center gap-5 mb-8 pb-8 border-b border-slate-100">
                        ...
                        <div>
                            <h2 class="text-3xl font-extrabold tracking-tight text-slate-900">Market Insights</h2>
                            <p class="text-sm text-slate-500 font-medium mt-1">Analysis Reports & Customised Research</p>
                        </div>
                    </div>
