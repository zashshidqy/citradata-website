        ...
        <section class="py-12 md:py-20 relative z-10">
            <div class="max-w-4xl mx-auto px-4 md:px-6 space-y-12">
                ...
                <article class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 overflow-hidden">
                    <!-- Header Image -->
                    <div class="h-32 md:h-40 bg-gradient-to-br from-slate-100 to-slate-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80" 
                             alt="About Citradata" 
                             class="w-full h-full object-cover opacity-70">
                        <div class="absolute inset-0 bg-gradient-to-r from-slate-900/60 to-slate-900/20"></div>
                        <div class="absolute bottom-4 left-6 md:left-8 flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl bg-white/90 backdrop-blur-sm flex items-center justify-center text-slate-700">
                                <i class="fas fa-info-circle text-lg"></i>
                            </div>
                            <div class="text-white">
                                <h3 class="font-bold text-lg">About Us</h3>
                                <p class="text-xs opacity-80">Established 1988</p>
                            </div>
                        </div>
                    </div>
                ...
                <article class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 overflow-hidden">
                    <!-- Header Image -->
                    <div class="h-32 md:h-40 bg-gradient-to-br from-red-100 to-red-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80" 
                             alt="Our Mission" 
                             class="w-full h-full object-cover opacity-70">
                        <div class="absolute inset-0 bg-gradient-to-r from-red-900/60 to-red-900/20"></div>
                        <div class="absolute bottom-4 left-6 md:left-8 flex items-center gap-3">
                            ...
                            <div class="text-white">
                                ...
                                <p class="text-xs opacity-80">Quality, Partnership & Expansion</p>
                            </div>
                        </div>
                    </div>
